...
```{r integration_auto_params_note, results='asis', eval=!is.null(int_auto_selection)}
cat(sprintf(
  '**Automatic integration parameters:** %d principal components and Louvain resolution %s were selected via bootstrap cluster stability (combined ARI/Jaccard score). Full stability tables are in `%s`.\n',
...
```{r integration_stability_plots, fig.width=10, fig.height=6, eval=!is.null(int_auto_selection)}
