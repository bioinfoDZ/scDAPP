...
sobjlist <- lapply(sample_metadata$Code, function(code){
  ...
  #as of Aug 3 2024, turn off glmGamPoi due to error related to future global maxsize??
  # also, vst.flaver = 'v2' appears to be the default
  # sobj <- SCTransform(sobj, assay = "RNA", verbose = verbose )
